...
# Decode-time repetition penalty (vLLM logit penalty; 1.0 = off). Prevents wasting compute
# generating degenerate loops. Pair with sampling presence_penalty per the model card.
